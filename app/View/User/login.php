        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="loginForm" action="/QuanLiTrungTamTA/login" method="POST">
                    ...
                    <div class="form-group">
                        <a href="#" data-dismiss="modal" data-toggle="modal" data-target="#forgotPasswordModal" class="float-right">Quên mật khẩu?</a>
                    </div>
...
<?php include './app/View/User/forgotPassword.php'; ?>
